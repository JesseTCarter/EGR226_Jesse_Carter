...
Description:    This code is used to see if the ADC was configured properly,
                by using a potentiometer to the 3.3V supply and ground so
                that it will generate a test voltage when the knob is turned
                that will be displayed in Code Composer Studios console window.
